...
5. Confirm weekly availability and final lecturer deadline, then turn the tasks below into GitHub issues with owner/reviewer and milestone. Suggested labels are identifiers, not existing issue numbers.
6. Run a 60-minute kickoff: 15 minutes setup, 20 minutes business questions, 15 minutes responsibilities/contracts, 10 minutes next demo. Track unanswered A decisions in the brief.
...
| NEG-01 Negotiation/hold specification | M3 Quốc Nguyên | UC-06/07, proposal vs accepted-hold distinction, acceptance/expiry sequence and concurrency test cases | A04/A05, M2 listing contract; no new tables before contract review | M2 | D3 |
| TRADE-01 Handover/rating specification | M4 Thành Nguyên | UC-08/09, code recovery options, transition diagram, rating ledger contract and test cases | A06/A07; do not implement auto-completion | M3 + M1 for ledger | D3 |
| MOD-01 Moderation/reporting specification | M5 Việt | UC-04/10, moderator queue/report fields, decision audit and report metric definitions | A08/A09/A12/A15; do not penalize on report submission alone | M4 | D3 |
...
| M2 | Listings, category tree, images, geographic search, combos | Listing renewal | M3 holds, M5 moderation/campaigns |
| M3 | Chat, price proposals, reservations and appointments | Hold expiry | M2 availability, M4 completion |
| M4 | Handover confirmation, history, ratings; test evidence | Completion-code expiry | M3 races, M1 ledger |
| M5 | Moderation, complaints, campaigns and reports | Notification/job coordination, not every domain job | M1 restrictions, M2 publication |
...
>
> Tài liệu yêu cầu ở docs/product/brief.md, công nghệ ở docs/architecture/ADR-001-stack.md, phân công ở docs/onboarding/team-kickoff.md. Các câu hỏi nghiệp vụ đang OPEN không được để AI tự quyết định.
>
